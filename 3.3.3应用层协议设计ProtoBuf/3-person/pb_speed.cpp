 ...
 * @LastEditTime: 2020-06-09 22:10:04
 */
#include <iostream>
#include <stdio.h>
#include <unistd.h>
...
static void printPerson(IM::Login::Person &person)
{
    ...
    for (int i = 0; i < person.languages_size(); i++) // repeated字段 _size()
    {
        if (i != 0)
        {
            languages += ", ";
...
/*
ProtobufDecode, size: 86
protobuf encode time testing
protobuf encode 100000 time, need time: 221ms
protobuf decode time testing
protobuf decode 100000 time, need time: 160ms
*/